...
List<NotifcationsModel> notificationModelFromJson(List<dynamic> str) =>
    List<NotifcationsModel>.from(
        (str).map((x) => NotifcationsModel.fromJson(x)));

String productCategoryModelToJson(List<NotifcationsModel> data) =>
...
class NotifcationsModel {
  ...
  factory NotifcationsModel.fromJson(Map<String, dynamic> json) =>
      NotifcationsModel(
