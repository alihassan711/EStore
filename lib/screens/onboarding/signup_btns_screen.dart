            ...
            child: Column(
              ...
              children: [
                CustomWidgets.socialButtonRect(
                    getTranslated(context, "facebook_sign_in").toString(),
                    facebookColor,
                    FontAwesomeIcons.facebookF, onTap: () {
                  // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>PhoneAuthForm()));
                  Fluttertoast.showToast(
                      msg: 'I am facebook', backgroundColor: facebookColor);
                }),
                SizedBox(
                  height: 14,
                ),
                CustomWidgets.socialButtonRect(
                    getTranslated(context, "google_sign_in").toString(),
                    googleColor,
                    FontAwesomeIcons.googlePlusG, onTap: () {
                  _fireBaseServices.signup(context);
                  Fluttertoast.showToast(
                      msg: 'I am google', backgroundColor: googleColor);
                }),
                SizedBox(
                  height: 14,
                ),
                CustomWidgets.socialButtonRect(
                    getTranslated(context, "email_sign_in").toString(),
                    linkedinColor,
                    Icons.email, onTap: () {
                ...
                CustomWidgets.socialButtonRect(
                    getTranslated(context, "apple_sign_in").toString(),
                    githubColor,
                    FontAwesomeIcons.apple, onTap: () {
                  Fluttertoast.showToast(
                      msg: 'I am Apple', backgroundColor: githubColor);
                }),
                SizedBox(
                  height: 14,
                ),
                CustomWidgets.socialButtonRect(
                    getTranslated(context, "phone_sign_in").toString(),
                    phoneColor,
                    FontAwesomeIcons.phoneAlt, onTap: () {
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => PhoneAuthForm()));
                  Fluttertoast.showToast(
                      msg: 'I am Phone', backgroundColor: phoneColor);
                }),
                SizedBox(
                  height: 14,
                ),
